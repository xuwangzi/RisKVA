...
class Qwen2_5_VLVisionAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return Qwen2_5_VLVisionAttention_forward(self, hidden_states, cu_seqlens, rotary_pos_emb, position_embeddings, attention_mask, **kwargs)
...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        return Qwen2_5_VLModel_forward(self, input_ids, attention_mask, position_ids, past_key_values, inputs_embeds, use_cache, output_attentions, output_hidden_states, return_dict, pixel_values, pixel_values_videos, image_grid_thw, video_grid_thw, rope_deltas, cache_position, second_per_grid_ts, **kwargs)
...
def Qwen2_5_VLForConditionalGeneration_forward(
    ...
    **kwargs: Unpack[KwargsForCausalLM],
    ...
    if RETURN_HIDDEN_STATES:
        ...
        # ========= OLD non fused =========
        # logits = self.lm_head(hidden_states.to(lm_head_weight.device))
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        return Qwen2_5_VLForConditionalGeneration_forward(self, input_ids, attention_mask, position_ids, past_key_values, inputs_embeds, labels, use_cache, output_attentions, output_hidden_states, pixel_values, pixel_values_videos, image_grid_thw, video_grid_thw, rope_deltas, cache_position, second_per_grid_ts, **kwargs)
