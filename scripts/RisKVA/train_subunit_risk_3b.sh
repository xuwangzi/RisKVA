...
# =================================================================
# RisKVA 子单元风险分析训练脚本 - Qwen2.5-VL-3B-Instruct (内存优化版)
# =================================================================
...
OUTPUT_DIR="models/finetuned_models/RisKVA/RisKVA-Qwen2.5-VL-3B-Instruct-sft-subunit-risk"
...
accelerate launch \
    ...
    2>&1 | tee "${LOG_DIR}/train_subunit_risk_3b_${TIMESTAMP}.log"

echo "========================================"
echo "训练完成！"
echo "模型保存在: ${OUTPUT_DIR}"
echo "训练日志: ${LOG_DIR}/train_subunit_risk_3b_${TIMESTAMP}.log"
echo "========================================"