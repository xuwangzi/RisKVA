...
if __name__ == "__main__":
    # 简单的命令行参数解析
    if len(sys.argv) > 1:
        parser = argparse.ArgumentParser(description="房屋分户检查风险评估推理工具")
        parser.add_argument("--pretrained_model_path", default="models/pretrained_models/Qwen/Qwen2.5-VL-3B-Instruct")
        parser.add_argument("--finetuned_model_path", default="models/finetuned_models/RisKVA/RisKVA-Qwen2.5-VL-3B-Instruct-sft-subunit-risk")
        parser.add_argument("--dataset_path", default="datasets/RisKVA/Subunit-Risk_test/metadata.csv")
